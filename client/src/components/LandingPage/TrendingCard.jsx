    ...
    return <div className={styles.trending_card}>
        ...
        <div className={styles.trending_card_2}>
            <span className={styles.trending_card_2_1}>
                <img src={"https://lh3.googleusercontent.com/a-/AOh14GhMpDxAbi29_o8MlTCxt7l_ta6r_8KY4vWDzS0rvno=s96-c"} alt=""></img>
                <h6>{"Pratik J"}</h6>
            </span>
            <span onClick={handleBlog} className={styles.trending_card_2_2}>
                <h4>{"Dual Boot is Dead: Windows and Linux are now One"}</h4>
            </span>
