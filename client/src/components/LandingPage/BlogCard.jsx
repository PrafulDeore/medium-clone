    ...
    <div className={styles.blog_card}>
      <div className={styles.blog_card_2}>
        <span className={styles.blog_card_2_1}>
          <img
            src={"https://lh3.googleusercontent.com/a-/AOh14GhMpDxAbi29_o8MlTCxt7l_ta6r_8KY4vWDzS0rvno=s96-c"}
            alt=""
          ></img>
          <h6>{"Pratik J"}</h6>
        </span>
        ...
        <span className={styles.blog_card_2_4}>
          <p>{"Turn your Windows machine into a developer workstation with WSL 2."}</p>
        </span>
      ...
      <div onClick={handleBlog} className={styles.blog_card_1}>
        <img
          src={"http://res.cloudinary.com/someshcloudinary/image/upload/v1633071590/be4oqgnrrou6dgwnuodc.png"}
          alt=""
        ></img>
      </div>
    </div>
